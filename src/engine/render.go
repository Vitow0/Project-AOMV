...
func (e *Engine) HomeRendering() {
	...
	rl.DrawText("Load game", int32(rl.GetScreenWidth())/2-rl.MeasureText("[Enter] to Play", 20)/2, int32(rl.GetScreenHeight())/2+50, 20, rl.RayWhite)
	rl.DrawText("[Esc] to Quit", int32(rl.GetScreenWidth())/2-rl.MeasureText("[Esc] to Quit", 25)/2, int32(rl.GetScreenHeight())/2+100, 20, rl.RayWhite)
...
func (e *Engine) PauseRendering() {
	...
	rl.DrawText("[Q]/[A] to Quit", int32(rl.GetScreenWidth())/2-rl.MeasureText("[Esc] to Quit", 25)/2, int32(rl.GetScreenHeight())/2+100, 20, rl.RayWhite)
